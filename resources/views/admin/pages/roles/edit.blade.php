        ...
        <div class="card mg-b-20">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <ul id="treeview1">
                            <li><a href="#">{{trans('Works_trans.permissions')}}</a>
                                <ul>
                                    <li>
                                        @foreach($permission as $value)
                                        <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name form-group')) }}
                                            {{ $value->name }}</label>
                                        <br/>
                                        @endforeach
                                    </li>
